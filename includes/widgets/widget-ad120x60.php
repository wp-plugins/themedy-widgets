...
class themedy_ad120x60_widget extends WP_Widget {
	...
	function __construct() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'themedy_ad120x60_widget', 'description' => __('A widget that allows the display and configuration of of a single 120x60 Banner.', 'themedy') );

		/* Widget control settings */
		//$control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'themedy_ad300_widget' );

		/* Create the widget */
		parent::__construct( 'themedy_ad120x60_widget', __('Themedy - 120x60 Ad', 'themedy'), $widget_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array(
		'title' => '',
		'ad' => plugin_dir_url( __FILE__ ) . "images/ad-120x60.png",
